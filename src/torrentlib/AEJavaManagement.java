...
AEJavaManagement 
{
	...
	{
		try{
			thread_stuff = (ThreadStuff)Class.forName( "core3.util.jman.AEThreadMonitor" ).newInstance();
		...
		try{
			memory_stuff = (MemoryStuff)Class.forName( "core3.util.jman.AEMemoryMonitor" ).newInstance();
