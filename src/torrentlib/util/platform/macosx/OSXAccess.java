 ...
 */
package torrentlib.util.platform.macosx;
 ...
 * @created Jul 21, 2006
 *
 * javah -d . -classpath ../../../../../../../../bin platform.macosx.access.jnilib.OSXAccess
 */
	...
	private static void initialize() {
		try {
			...
			if (System.getProperty("osxaccess.light", "0").equals("1")) {
				...
				Class<?> claOSXFileOpen = Class.forName("ui.swt.osx.OSXFileOpen");
