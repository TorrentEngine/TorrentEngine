...
import torrentlib.util.platform.macosx.OSXAccess;
...
public class PlatformManagerImpl implements PlatformManager, AEDiagnosticsEvidenceGenerator
{
    ...
    /**
     * {@inheritDoc}
     * @see core3.util.SystemProperties#getUserPath()
     */
    ...
    private Class<?> getFileManagerClass() {
    	if (claFileManager != null) {
			...
			try {
				...
				// working
				Class<?> claCocoaUIEnhancer = Class.forName("ui.swt.osx.CocoaUIEnhancer");
