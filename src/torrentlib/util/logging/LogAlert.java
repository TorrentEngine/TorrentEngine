 ...
 *
 */
package torrentlib.util.logging;

import torrentlib.util.GeneralUtils;
...
// @Code-note: Frostwire version of this file has "implements..." commented out.

public class LogAlert implements plugins.logging.LogAlert
{
   // log types

   // @Code-note: These three are from the Frostwire version of this file.
   ...
   public Object[] getContext()
   {
      ...
      {
         // @Code-note: This line is commented out in Frostwire version of this file.
   ...
   public int getTimeoutSecs()
   {
      ...
      // @Code-note: Frostwire version of this file uses: "return 1000;"
      return COConfigurationManager.getIntParameter("Message Popup Autoclose in Seconds");
   }

   // @Code-note: Frostwire version of this file does not have this method.
