 ...
 *
 */
public class PlatformTorrentUtils2
{
...
//	}
	...
	public static boolean isContent(TOTorrent torrent,
		...
		boolean bContent = PlatformTorrentUtils2.getContentHash(torrent) != null;
	...
	public static String getContentTitle2(DownloadManager dm) {
		...
		if (name == null || name.length() == 0) {
			name = PlatformTorrentUtils2.getContentTitle(dm.getTorrent());
			if (name == null) {
