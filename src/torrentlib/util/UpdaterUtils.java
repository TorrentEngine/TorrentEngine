		...
		try{
			...
			if ( target_props != null ){
				...
				writePluginProperties(
					target_props,
					new String[]{
						"plugin.class=update.UpdaterUpdateChecker;update.UpdaterPatcher",
			...
			if ( target_props != null ){
				...
				writePluginProperties(
					target_props,
					new String[]{
						"plugin.class=plugins.upnpmediaserver.UPnPMediaServer",
			...
			if ( target_props != null ){
				...
				writePluginProperties(
					target_props,
					new String[]{
						"plugin.class=plugins.featman.FeatManPlugin",
