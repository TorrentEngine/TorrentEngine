...
package torrentlib.speedmanager;
...
import torrentlib.AEDiagnosticsLogger;
...
import torrentlib.speedmanager.SpeedManagerLimitEstimate;
import torrentlib.speedmanager.SpeedManagerListener;
import torrentlib.speedmanager.SpeedManagerPingMapper;
import torrentlib.speedmanager.SpeedManagerPingSource;
import torrentlib.speedmanager.SpeedManagerAlgorithm;
	...
	implements SpeedManager, SpeedManagerAlgorithmProviderAdapter, AEDiagnosticsEvidenceGenerator
{
	...
	setSpeedAlgorithm()
	{
		...
		if ( !( provider instanceof SpeedManagerAlgorithm )){

				provider = new SpeedManagerAlgorithm( this );
		}
