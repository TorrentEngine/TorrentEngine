...
{
	public static final String	DEFAULT_MANAGER = "torrentlib.disk.cache.impl.CacheFileManagerImpl";
		...
		try{
			...
			if ( manager == null ){
				...
				if ( impl == null ){
					...
					impl = System.getProperty( "core.diskmanager.cache.manager");
				}
