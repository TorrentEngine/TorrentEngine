...
package torrentlib.versioncheck;
...
import torrentlib.stats.OverallStats;
import torrentlib.stats.StatsFactory;
import torrentlib.clientmessageservice.ClientMessageService;
import torrentlib.clientmessageservice.ClientMessageServiceClient;
...
import xfer.download.DownloadManagerStateImpl;
...
import controller.networkmanager.admin.NetworkAdminASN;
...
import comm.udp.PRUDPReleasablePacketHandler;
import torrentlib.TorrentEngineCore;
...
public class VersionCheckClient {
		...
		String[]	args )
	{
		try{
			 ...
			 */
			TorrentEngineCore.SUPPRESS_CLASSLOADER_ERRORS = true;
