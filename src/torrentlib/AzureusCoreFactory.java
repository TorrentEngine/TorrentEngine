...
AzureusCoreFactory 
{
	...
	create()
		...
		throws AzureusCoreException
	{
		return( TorrentEngineCore.create());
	}
	...
	isCoreAvailable()
	{
		return( TorrentEngineCore.isCoreAvailable());
	}
	...
	public static boolean
	isCoreRunning() {
		return TorrentEngineCore.isCoreRunning();
	}
		/**
	...
	getSingleton()
		...
		throws AzureusCoreException
	{
		return( TorrentEngineCore.getSingleton());
	}	
	...
	addCoreRunningListener(AzureusCoreRunningListener l) {
		TorrentEngineCore.addCoreRunningListener(l);
	}
}
