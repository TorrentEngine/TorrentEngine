 ...
 */
package connect.peermanager.messaging.bittorrent.ltep;
...
import connect.peer.messaging.MessagingUtil;
	  ...
	  public static void main(String[] args) throws Exception {
        ...
        for (int i=1; i<6; i++) {
        	...
        	while (itr.hasNext()) {
        		...
        		System.out.println(k + ": " + core3.util.ByteFormatter.encodeString(b));
        	}
        	System.out.println('-');
        }
