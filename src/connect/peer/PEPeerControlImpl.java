...
import torrentlib.disk.DiskManagerWriteRequestListener;
import torrentlib.disk.DiskManagerPiece;
import torrentlib.disk.DiskManager;
import torrentlib.disk.DiskManagerCheckRequestListener;
import torrentlib.disk.DiskManagerWriteRequest;
import torrentlib.disk.DiskManagerCheckRequest;
...
import connect.peermanager.PeerDatabase;
import connect.peermanager.PeerDatabaseFactory;
...
import torrentlib.disk.DiskManager.GettingThere;
...
import connect.tracker.client.TRTrackerScraperResponse;
import plugins.download.DownloadAnnounceResultPeer;
import plugins.network.Connection;
import plugins.network.OutgoingMessageQueue;
import plugins.peers.Peer;
import plugins.peers.PeerDescriptor;
...
import connect.peermanager.PeerManagerRegistration;
import connect.peermanager.PeerControlInstance;
import connect.peermanager.PeerControlScheduler;
import connect.peermanager.PeerControlSchedulerFactory;
import connect.peermanager.PeerNATInitiator;
import connect.peermanager.PeerNATTraversalAdapter;
import connect.peermanager.PeerNATTraverser;
import connect.peermanager.piecepicker.PiecePicker;
import connect.peermanager.piecepicker.PiecePickerFactory;
import connect.peermanager.unchoker.Unchoker;
import connect.peermanager.unchoker.UnchokerFactory;
import connect.peermanager.unchoker.UnchokerUtil;
import connect.peermanager.uploadslots.UploadHelper;
import connect.peermanager.uploadslots.UploadSlotManager;
import connect.tracker.peer.TrackerPeerSource;
import connect.tracker.peer.TrackerPeerSourceAdapter;
import torrentlib.util.FeatureAvailability;
...
//	get the remaining percentage
	 ...
	 * @see torrentlib.disk.DiskManagerWriteRequestListener
	 */
