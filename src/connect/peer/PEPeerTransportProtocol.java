...
import torrentlib.IPToHostNameResolverRequest;
import torrentlib.DirectByteBufferPool;
import torrentlib.DirectByteBuffer;
import torrentlib.StringInterner;
import torrentlib.IPToHostNameResolver;
...
import torrentlib.IPToHostNameResolverListener;
import torrentlib.ByteFormatter;
import stdlib.security.types.SHA1Hasher;
import torrentlib.AENetworkClassifier;
import connect.peer.PEPeerStats;
...
import connect.peermanager.utils.PeerClassifier;
import connect.peermanager.utils.ClientIdentifier;
import connect.peermanager.utils.OutgoingBTHaveMessageAggregator;
import connect.peermanager.utils.AZPeerIdentityManager;
import connect.peermanager.utils.PeerMessageLimiter;
import connect.peermanager.utils.OutgoingBTPieceMessageHandler;
import connect.peermanager.utils.OutgoingBTPieceMessageHandlerAdapter;
import connect.peermanager.messaging.bittorrent.ltep.LTMessageDecoder;
import connect.peermanager.messaging.bittorrent.ltep.LTMessage;
import connect.peermanager.messaging.bittorrent.ltep.UTUploadOnly;
import connect.peermanager.messaging.bittorrent.ltep.LTHandshake;
import connect.peermanager.messaging.bittorrent.ltep.UTMetaData;
import connect.peermanager.messaging.bittorrent.ltep.UTPeerExchange;
import connect.peermanager.messaging.bittorrent.ltep.LTMessageEncoder;
import connect.peermanager.messaging.bittorrent.BTChoke;
import connect.peermanager.messaging.bittorrent.BTRejectRequest;
import connect.peermanager.messaging.bittorrent.BTMessage;
import connect.peermanager.messaging.bittorrent.BTUnchoke;
import connect.peermanager.messaging.bittorrent.BTHave;
import connect.peermanager.messaging.bittorrent.BTInterested;
import connect.peermanager.messaging.bittorrent.BTMessageDecoder;
import connect.peermanager.messaging.bittorrent.BTMessageFactory;
import connect.peermanager.messaging.bittorrent.BTDHTPort;
import connect.peermanager.messaging.bittorrent.BTHaveNone;
import connect.peermanager.messaging.bittorrent.BTCancel;
import connect.peermanager.messaging.bittorrent.BTRequest;
import connect.peermanager.messaging.bittorrent.BTHandshake;
import connect.peermanager.messaging.bittorrent.BTSuggestPiece;
import connect.peermanager.messaging.bittorrent.BTKeepAlive;
import connect.peermanager.messaging.bittorrent.BTMessageEncoder;
import connect.peermanager.messaging.bittorrent.BTPiece;
import connect.peermanager.messaging.bittorrent.BTHaveAll;
import connect.peermanager.messaging.bittorrent.BTUninterested;
import connect.peermanager.messaging.bittorrent.BTRawMessage;
import connect.peermanager.messaging.bittorrent.BTAllowedFast;
import connect.peermanager.messaging.bittorrent.BTBitfield;
import connect.peermanager.messaging.azureus.AZStatReply;
import connect.peermanager.messaging.azureus.AZHandshake;
import connect.peermanager.messaging.azureus.AZStatRequest;
import connect.peermanager.messaging.azureus.AZStylePeerExchange;
import connect.peermanager.messaging.azureus.AZPeerExchange;
import connect.peermanager.messaging.azureus.AZMessageEncoder;
import connect.peermanager.messaging.azureus.AZBadPiece;
import connect.peermanager.messaging.azureus.AZHave;
import connect.peermanager.messaging.azureus.AZUTMetaData;
import connect.peermanager.messaging.azureus.AZMessage;
import connect.peermanager.messaging.azureus.AZRequestHint;
import connect.peermanager.messaging.azureus.AZMessageDecoder;
import connect.peermanager.messaging.azureus.AZMetaData;
...
import controller.networkmanager.OutgoingMessageQueue;
import controller.networkmanager.IncomingMessageQueue;
...
import torrentlib.disk.DiskManagerReadRequest;
import connect.peer.PEPeerControl;
import connect.peer.PEPeerTransport;
import connect.peer.PEPeerTransportFactory;
import connect.peer.PeerIdentityDataID;
import connect.peer.PeerIdentityManager;
import connect.peer.PeerUtils;

import plugins.clientid.ClientIDGenerator;
import plugins.dht.mainline.MainlineDHTProvider;
...
import connect.peer.messaging.Message;
import connect.peer.messaging.MessageManager;
import connect.peer.messaging.MessageStreamEncoder;
import connect.peermanager.PeerExchangerItem;
import connect.peermanager.PeerItem;
import connect.peermanager.PeerItemFactory;
import connect.peermanager.piecepicker.PiecePicker;
import connect.peermanager.piecepicker.BitFlags;
import comm.proxy.AEProxyAddressMapper;
import comm.proxy.AEProxyFactory;
...
implements PEPeerTransport
{
	...
	start()
	{
		...
		if ( incoming ){
			...
			connection.connect(ProtocolEndpoint.CONNECT_PRIORITY_MEDIUM,
			...
			Map				_initial_user_data )
	{
		...
		connection.connect(initial_outbound_data,
				priority,
				new NetworkConnection.ConnectionListener()
				{
	...
	/* (non-Javadoc)
	 * @see core3.peer.impl.PEPeerTransport#isSafeForReconnect()
	 */
  ...
  getOutboundDataQueueSize()
  {
	...
	/* (non-Javadoc)
	 * @see core3.logging.LogRelation#queryForClass(java.lang.Class)
	 */
	...
	private static MainlineDHTProvider getDHTProvider() {
		return TorrentEngineCore.getSingleton().getGlobalManager().getMainlineDHTProvider();
	}
