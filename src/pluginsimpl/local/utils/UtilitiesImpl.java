...
package pluginsimpl.local.utils;
...
import torrentlib.util.platform.win32.PluginState;
...
import plugins.utils.FeatureManager;
import plugins.utils.DelayedTask;
import plugins.utils.ScriptProvider;
import plugins.utils.Utilities;
import plugins.utils.ByteArrayWrapper;
import plugins.utils.LocationProviderListener;
import plugins.utils.PowerManagementListener;
import plugins.utils.UTTimer;
import plugins.utils.Monitor;
import plugins.utils.AggregatedList;
import plugins.utils.AggregatedListAcceptor;
import plugins.utils.Semaphore;
import plugins.utils.Formatters;
import plugins.utils.PooledByteBuffer;
import plugins.utils.LocaleUtilities;
import plugins.utils.LocationProvider;
import plugins.utils.AggregatedDispatcher;
import plugins.utils.resourcedownloader.ResourceDownloaderFactory;
import plugins.utils.resourcedownloader.ResourceDownloader;
import plugins.utils.resourcedownloader.ResourceDownloaderException;
import pluginsimpl.local.utils.resourcedownloader.ResourceDownloaderFactoryImpl;
import pluginsimpl.local.utils.security.SESecurityManagerImpl;
import pluginsimpl.local.utils.xml.simpleparser.SimpleXMLParserDocumentFactoryImpl;
...
import plugins.ddb.DistributedDatabase;
import plugins.download.Download;
import plugins.network.RateLimiter;
import plugins.tag.Tag;
import plugins.tag.TagManager;
import plugins.torrent.Torrent;
import plugins.utils.ScriptProvider.ScriptProviderListener;
import plugins.utils.resourceuploader.ResourceUploaderFactory;
import plugins.utils.search.SearchException;
import plugins.utils.search.SearchInitiator;
import plugins.utils.search.SearchProvider;
import plugins.utils.security.SESecurityManager;
import plugins.utils.subscriptions.Subscription;
import plugins.utils.subscriptions.SubscriptionException;
import plugins.utils.subscriptions.SubscriptionManager;
import plugins.utils.subscriptions.SubscriptionResult;
import plugins.utils.xml.rss.RSSFeed;
import plugins.utils.xml.simpleparser.SimpleXMLParserDocumentException;
import plugins.utils.xml.simpleparser.SimpleXMLParserDocumentFactory;
import pluginsimpl.local.PluginInitializer;
import pluginsimpl.local.ddb.DDBaseImpl;
import pluginsimpl.local.network.ConnectionManagerImpl;
import pluginsimpl.local.utils.resourceuploader.ResourceUploaderFactoryImpl;
// import pluginsimpl.local.utils.xml.rss.RSSFeedImpl;
import controller.config.COConfigurationManager;
import comm.ipchecker.extipchecker.ExternalIPChecker;
import comm.ipchecker.extipchecker.ExternalIPCheckerFactory;
import comm.ipchecker.extipchecker.ExternalIPCheckerService;
import comm.ipchecker.extipchecker.ExternalIPCheckerServiceListener;
...
import comm.proxy.AEProxyFactory.PluginProxy;
	...
	implements Utilities, FeatureManager
{
  ...
  public long getCurrentSystemTime() {
	...
	{
		try{
			Method m = Class.forName( "core.subs.SubscriptionManagerFactory" ).getMethod( "getSingleton" );
		...
		implements TagManager
	{
		...
		getTags()
		{
			List<torrentlib.data.tag.Tag> tags = TagManagerFactory.getTagManager().getTagType( TagType.TT_DOWNLOAD_MANUAL ).getTags();
