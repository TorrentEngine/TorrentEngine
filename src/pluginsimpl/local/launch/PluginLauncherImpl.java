...
package pluginsimpl.local.launch;
...
import torrentlib.util.platform.win32.LaunchablePlugin;
...
import torrentlib.util.Launcher;
...
PluginLauncherImpl
{
		...
		String[]		args )
	{
		...
		try{
			...
			SystemProperties.setApplicationEntryPoint( "plugins.PluginLauncher" );
				...
				new Thread( "PluginLauncher" )
				{
					...
					run()
					{
						try{
							...
							TorrentEngineCore azureus_core = AzureusCoreFactory.create();
