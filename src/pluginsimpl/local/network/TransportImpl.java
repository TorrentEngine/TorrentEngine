...
public class TransportImpl implements Transport {
  private controller.networkmanager.Transport core_transport;
  ...
  public TransportImpl( controller.networkmanager.Transport core_transport ) {
  ...
  public controller.networkmanager.Transport coreTransport() throws IOException {
  ...
  public void setFilter(TransportFilter filter) throws IOException {
	  ((controller.networkmanager.Transport)coreTransport()).setFilter(
