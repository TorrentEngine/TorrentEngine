...
import plugins.network.ConnectionListener;
...
public class ConnectionImpl implements Connection {
  ...
  private final controller.networkmanager.NetworkConnection core_connection;
  ...
  public ConnectionImpl( controller.networkmanager.NetworkConnection core_connection, boolean incoming ) {
  ...
  public void connect( final ConnectionListener listener ) {
    core_connection.connect(ProtocolEndpoint.CONNECT_PRIORITY_MEDIUM, new controller.networkmanager.NetworkConnection.ConnectionListener() {
  ...
  public controller.networkmanager.NetworkConnection getCoreConnection() {
  ...
  getString()
  {
	   controller.networkmanager.Transport t = core_connection.getTransport();
