...
import plugins.network.RawMessage;
 ...
 *
 */
public class RawMessageAdapter extends MessageAdapter implements RawMessage, controller.networkmanager.RawMessage {
  private RawMessage plug_msg = null;
  private controller.networkmanager.RawMessage core_msg = null;
  ...
  public RawMessageAdapter( controller.networkmanager.RawMessage core_msg ) {
    super( core_msg );
  ...
  public int getPriority() {  return controller.networkmanager.RawMessage.PRIORITY_NORMAL;  }
  ...
  public plugins.messaging.Message getOriginalMessage() {
    if( plug_msg == null ) {
