	...
	extends PluginManager
{
	...
	protected static TorrentEngineCore		azureus_core;
		...
		Properties	properties )
	{
		...
		if ( ui_type == PluginManager.UI_NONE ){
				...
				// ui.common.Main.main( new String[]{"--ui=console"});
			...
			if ( mi != null && mi.equalsIgnoreCase("true")){
				...
				// 	ui.swt.Main.main(new String[0]);

			try{
				Class.forName( "ui.swt.Main" ).getMethod(
