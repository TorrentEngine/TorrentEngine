...
package pluginsimpl.local.peers;
...
import plugins.peers.PeerListener;
...
import plugins.network.ConnectionStub;
...
import pluginsimpl.local.utils.UtilitiesImpl.PluginLimitedRateGroup;
	...
	implements 	PEPeerTransport
{
  ...
  public void setOptimisticUnchoke( boolean is_optimistic ) {
	...
	{
		plugins.messaging.Message[] plug_msgs = foreign.getSupportedMessages();
