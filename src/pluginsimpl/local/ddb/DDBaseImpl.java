...
package pluginsimpl.local.ddb;

import plugins.ddb.DistributedDatabaseTransferHandler;
...
import plugins.ddb.DistributedDatabaseException;
...
import plugins.ddb.DistributedDatabaseKeyStats;
...
import plugins.dht.DHTPluginInterface;
import plugins.dht.DHTPluginContact;
import plugins.dht.DHTPluginKeyStats;
import plugins.dht.DHTPluginListener;
	...
	implements DistributedDatabase
{
	...
	final private TorrentEngineCore				azureus_core;
	...
	protected
	DDBaseImpl(
		final TorrentEngineCore	_azureus_core )
	{
