...
import controller.GlobalManagerListener;
...
import pluginsimpl.local.launch.PluginLauncherImpl;
	...
	implements GlobalManagerListener, AEDiagnosticsEvidenceGenerator
{
  ...
  private String[][]	builtin_plugins = {
   			{	 PluginManagerDefaults.PID_START_STOP_RULES,
   					"plugins.startstoprules.defaultplugin.StartStopRulesDefaultPlugin",
   					"azbpstartstoprules",
   					"",
   					"true",
   					"true"},
   			{	 PluginManagerDefaults.PID_REMOVE_RULES,
   					"plugins.removerules.DownloadRemoveRulesPlugin",
   					"azbpremovalrules",
   					"",
					"true",
					"false"},
    		{	 PluginManagerDefaults.PID_SHARE_HOSTER,
   					"plugins.sharing.hoster.ShareHosterPlugin",
   					"azbpsharehoster",
   					"ShareHoster",
					"true",
					"false"},
   			{	 PluginManagerDefaults.PID_PLUGIN_UPDATE_CHECKER,
   					"pluginsimpl.update.PluginUpdatePlugin",
   					"azbppluginupdate",
   					"PluginUpdate",
					"true",
					"true"},
		...
		/*	{	 PluginManagerDefaults.PID_RSS,
					"core.rssgen.RSSGeneratorPlugin",
					"azintrss",
					"azintrss",
					"true",
					"false"},
         */
			...
			/* disable until we can get some tracker admins to work on this
	   		{	 PluginManagerDefaults.PID_TRACKER_PEER_AUTH,
					"plugins.tracker.peerauth.TrackerPeerAuthPlugin",
					"aztrackerpeerauth",
					"aztrackerpeerauth",
					"true",
					"false" },
  ...
  protected
  PluginInitializer(
  	TorrentEngineCore 			_azureus_core,
