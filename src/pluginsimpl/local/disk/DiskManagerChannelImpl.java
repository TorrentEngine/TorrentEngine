	...
	implements DiskManagerChannel, DiskManagerFileInfoListener, DownloadManagerPeerListener, PieceRTAProvider
{
	...
	private pluginsimpl.local.disk.DiskManagerFileInfoImpl	plugin_file;
	private torrentlib.disk.DiskManagerFileInfo					core_file;
	...
	DiskManagerChannelImpl(
		...
		pluginsimpl.local.disk.DiskManagerFileInfoImpl		_plugin_file )
