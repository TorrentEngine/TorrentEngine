...
import plugins.download.DownloadStubEvent;
...
import plugins.download.DownloadEventNotifier;
...
import plugins.download.DownloadStubListener;
...
import xfer.download.DownloadManagerDefaultPaths;
import xfer.download.DownloadManagerMoveHandler;
import controller.GlobalManagerDownloadRemovalVetoException;
import controller.GlobalManagerDownloadWillBeRemovedListener;
...
import plugins.download.savelocation.DefaultSaveLocationManager;
import plugins.download.savelocation.SaveLocationManager;
...
public class 
DownloadManagerImpl
	implements plugins.download.DownloadManager, DownloadManagerInitialisationAdapter
{
		...
		throws DownloadException
	{
		...
		DownloadManager dm = global_manager.addDownloadManager(torrent_file.toString(), hash, data_location.toString(),
