...
package pluginsimpl.local.download;
...
import plugins.download.DownloadPropertyListener;
...
import plugins.download.DownloadStats;
import plugins.download.DownloadTrackerListener;
import plugins.download.DownloadPeerListener;
import plugins.download.Download;
import plugins.download.DownloadListener;
import plugins.download.DownloadActivationEvent;
import plugins.download.DownloadAnnounceResult;
import plugins.download.DownloadRemovalVetoException;
import plugins.download.DownloadActivationListener;
import plugins.download.DownloadCompletionListener;
import plugins.download.DownloadPropertyEvent;
...
import xfer.download.DownloadManagerActivationListener;
import xfer.download.DownloadManagerStateAttributeListener;
import xfer.download.DownloadManagerStateListener;
import xfer.download.DownloadManagerState;
import xfer.download.DownloadManagerPeerListener;
import xfer.download.DownloadManagerTrackerListener;
import xfer.download.DownloadManagerStateEvent;
import xfer.download.DownloadManagerException;
import java.io.File;
import java.net.URL;
import java.util.*;

import torrentlib.category.Category;
import torrentlib.category.CategoryManager;
...
import torrentlib.util.CopyOnWriteMap;
				...
				DownloadManagerStateAttributeListener
{
  ...
  public boolean isPersistent() {
	...
	isComplete()
 	...
 	isMoving()
 	{
 		    torrentlib.disk.DiskManager dm = download_manager.getDiskManager();
	...
	public void
	filePriorityChanged( DownloadManager download, torrentlib.disk.DiskManagerFileInfo file )
	{	  
	}
  ...
  {	
	...
	public DiskManagerFileInfo getDiskManagerFileInfo(int index) {
		torrentlib.disk.DiskManagerFileInfo[] info = download_manager.getDiskManagerFileInfo();
	...
	getPrimaryFile() {
		torrentlib.disk.DiskManagerFileInfo primaryFile = download_manager.getDownloadState().getPrimaryFile();
