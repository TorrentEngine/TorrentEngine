...
import pluginsimpl.local.network.RawMessageAdapter;


/**
 *
 */
public class MessageStreamEncoderAdapter implements connect.peer.messaging.MessageStreamEncoder {
  ...
  public controller.networkmanager.RawMessage[] encodeMessage( connect.peer.messaging.Message message ) {
    Message plug_msg;
    ...
    return new controller.networkmanager.RawMessage[]{ new RawMessageAdapter( raw_plug )};
  }
