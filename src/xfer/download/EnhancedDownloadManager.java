...
import torrentlib.RealTimeInfo;
...
EnhancedDownloadManager 
{
	...
	isPlatform()
	{
		...
		if ( torrent != null ){
			...
			return( PlatformTorrentUtils2.isContent( torrent, true ));
		}
	...
	supportsProgressiveMode()
	{
		...
		return( enhancer.isProgressiveAvailable() && 
				( PlatformTorrentUtils2.isContentProgressive( torrent ) || explicit_progressive ));
	}
		...
		extends progressiveStats
	{
		...
		{		
			...
			content_stream_bps_min = explicit_progressive?content_min_delivery_bps:PlatformTorrentUtils2.getContentStreamSpeedBps( torrent );
