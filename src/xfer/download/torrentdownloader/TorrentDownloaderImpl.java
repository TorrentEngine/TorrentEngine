...
package xfer.download.torrentdownloader;
...
import xfer.download.torrentdownloader.TorrentDownloaderCallBackInterface;
import xfer.download.torrentdownloader.TorrentDownloader;
import torrentlib.protocol.MagnetConnection;
...
public class TorrentDownloaderImpl extends AEThread implements TorrentDownloader {
 ...
 redirect_label:
  ...
  /* (non-Javadoc)
   * @see core3.torrentdownloader.TorrentDownloader#getTotalRead()
   */
