...
import xfer.download.torrentdownloader.TorrentDownloaderImpl;
import xfer.download.torrentdownloader.TorrentDownloaderManager;
...
public class TorrentDownloaderFactory {
  ...
  private static TorrentDownloaderImpl getClass(boolean logged) {
    try {
      return (TorrentDownloaderImpl) Class.forName("core3.torrentdownloader.impl.TorrentDownloader"+(logged?"Logged":"")+"Impl").newInstance();
    } catch (Exception e) {
