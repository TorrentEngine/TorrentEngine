...
import xfer.download.torrentdownloader.TorrentDownloaderFactory;
...
public class TorrentDownloaderManager implements TorrentDownloaderCallBackInterface {
    ...
    public void TorrentDownloaderEvent(int state, xfer.download.torrentdownloader.TorrentDownloader inf) {
        switch(state) {
