...
package plugins.startstoprules.defaultplugin;
...
import torrentlib.LightHashSet;
import java.util.*;

import controller.config.COConfigurationListener;
		...
		COConfigurationListener, AEDiagnosticsEvidenceGenerator
{
	...
	private stdlib.math.average.Average globalDownloadSpeedAverage = AverageFactory.MovingImmediateAverage(SMOOTHING_PERIOD/PROCESS_CHECK_PERIOD );
