...
import torrentlib.util.platform.win32.PluginConfigListener;
...
import connect.dht.transport.udp.DHTTransportUDPImpl;
...
import plugins.dht.impl.DHTPluginContactImpl;
import plugins.dht.impl.DHTPluginImpl;
import plugins.dht.impl.DHTPluginImplAdapter;
		...
		plugin_interface.addListener(
			new PluginListener()
			{
				...
				initializationComplete()
				{
					...
					initComplete(logging.getValue(), ip);
				}
