...
import controller.networkmanager.admin.NetworkAdminSpeedTester;
	...
	implements NetworkAdminSpeedTester
{
    ...
    startUp()
    {
    	...
    	plugins.download.DownloadManager dm = plugin.getDownloadManager();
    ...
    class BitTorrentResult implements NetworkAdminSpeedTesterResult{
        ...
        public String toString(){
            StringBuffer sb = new StringBuffer("[core.networkmanager.admin.impl.NetworkAdminSpeedTesterBTImpl");
