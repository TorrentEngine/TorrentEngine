...
public class IpFilterAutoLoaderImpl
{
	...
	private void downloadFiltersAsync(URL url) {
		...
		rd.addListener(new ResourceDownloaderAdapter() {
			// @see plugins.utils.resourcedownloader.ResourceDownloaderAdapter#reportPercentComplete(plugins.utils.resourcedownloader.ResourceDownloader, int)
